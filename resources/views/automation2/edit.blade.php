	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			...
			<div class="automation-top-menu">
				<span class="mr-3"><i>Last saved: 2 minutes</i></span>
				...
				<div class="switch-automation d-flex">
					<select class="select select2 top-menu-select" name="switch_automation">
						...
						@foreach($automation->getSwitchAutomations()->get() as $auto)
	...
	<script>
        ...
        (function() {
            ...
            tree = AutomationElement.fromJson(json, container, {
                ...
                validate: function(e) {
                    if (e.getType() == 'ElementTrigger') {
                        if (e.getOptions()['init'] == null || e.getOptions()['init'] != "true") {
                    ...
                    if (e.getType() == 'ElementAction') {
                        ...
                        } else if (e.getOptions()['template'] == null || e.getOptions()['template'] != "true") {
