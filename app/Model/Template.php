...
class Template extends Model
{
    ...
    public function transform()
    {
        ...
        $this->content = \Acelle\Library\Tool::replaceTemplateUrl($this->content, route('template_assets', ['uid' => $this->uid, 'path' => '']));
    }
    ...
    /**
     * Delete template and it's directory.
     *
     * @return mixed
     */
